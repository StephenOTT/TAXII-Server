...
data class Envelop(
        ...
        @get:Schema(description = "This property identifies the server provided value of the next record or set of records in the paginated data set. This property \u200BMAY\u200B be populated if the \u200Bmore\u200B property is set to \u200Btrue.\u200B")
        val next: String? = null,

        @get:Schema(description = "This property contains one or more STIX Objects. Objects in this list \u200BMUST\u200B be a STIX Object (e.g., SDO, SCO, SRO, Language Content object, or a Marking Definition object).")
